//go:generate mockgen -destination=./mocks/http_mock.go -package mocks github.com/speakeasy-api/speakeasy-test-rest-service/internal/transport/http Users,DB
...
func New(u Users, db DB) (*Server, error) {
	return &Server{
		users: u,
		db:    db,
	}, nil
...
func (s *Server) AddRoutes(r *mux.Router) (http.Handler, error) {
	// Configure Speakeasy
