...
func TestServer_CreateUser_Success(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req, err := http.NewRequest(http.MethodPost, "/user", bytes.NewBuffer(data))
			require.NoError(t, err)
...
func TestServer_GetUser_Success(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req, err := http.NewRequest(http.MethodGet, fmt.Sprintf("/user/%s", tt.args.id), nil)
			require.NoError(t, err)
...
func TestServer_SearchUsers_Success(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req, err := http.NewRequest(http.MethodPost, "/users/search", bytes.NewBuffer(data))
			require.NoError(t, err)
...
func TestServer_UpdateUser_Success(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req, err := http.NewRequest(http.MethodPut, fmt.Sprintf("/user/%s", *tt.args.user.ID), bytes.NewBuffer(data))
			require.NoError(t, err)
...
func TestServer_DeleteUser_Success(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req, err := http.NewRequest(http.MethodDelete, fmt.Sprintf("/user/%s", tt.args.id), nil)
			require.NoError(t, err)
